...
- V6 正式 candidate：`326,076` Token，6 个答案变化，尚未提交官网。
- candidate 文件：`outputs/v6_evidence_final/answer.csv`。
- CSV SHA-256：`8E6DD42567F2E44F9CBE79693ADBE4D83FFDB09F6BAF5ED75BB33EB7466E4C02`。

V6 不把“预计修正”写成准确率。若 6 项均命中，理论上是 88/100、约 86.28 分；实际结果必须以官网为准。
...
1. 用 V6 正式得分反推 7 项中实际净增数量。
2. 用单变量 probe 判定两道标准答案歧义。
